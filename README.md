...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-29 03:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6169c7d0-4e86-428c-bd86-330f5a6303d6.git
$ cd 6169c7d0-4e86-428c-bd86-330f5a6303d6
```
